 ...
 */
contract OFTUpgradeable is OFTCoreUpgradeable, ERC20Upgradeable, ERC20PausableUpgradeable, ERC20BurnableUpgradeable {
    /**
    ...
    /**
     * @dev Allows pausing activity on the contract, for instance when upgrading it
     */
    ...
    /**
     * @dev Allows unpausing activity on the contract, after upgrading
     */
    function unpause() public onlyOwner {
        _unpause();
    }

    // defined in both parents, use pausable implementation
